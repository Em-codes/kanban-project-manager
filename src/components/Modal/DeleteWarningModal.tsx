...
const DeleteWarningModal = ({ type, currentBoard, currentTask, setShowMenu, setShowDeleteBoardModal }: deleteWarningProps) => {
    ...
    return (
        <div className="space-y-6 w-full mx-auto rounded-md bg-white dark:bg-darkGrey">
            ...
            {type === 'Board' ? <p className="text-[13px] text-black">Are you sure you want to delete the &apos;{currentBoard}&apos; board? This action will remove all columns and tasks and cannot be reversed.</p> :
                <p className="text-[13px] text-black">Are you sure you want to delete the  &apos;{currentTask}&apos; task and its subtasks? This action cannot be reversed</p>
            }
